...
// Просека design-system tokens (mapped from oklch to sRGB)
...
final ThemeData darkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    surface:          _muted,
    error:            _red,
    onPrimary:        _bg,    // dark text on light-green button
    onSecondary:      _bg,
    onSurface:        _fg,
    onError:          _fg,
  ...
  switchTheme: SwitchThemeData(
    thumbColor: WidgetStateProperty.resolveWith((states) {
      return states.contains(WidgetState.selected) ? _bg : _mutedFg;
    }),
